...
public class Program
{
    ...
    public static bool IsWhite(string coord)
    {
    ...
    public static double ConvertToFarengheit(double TempC)
    {
    ...
    static void Main()
    {
        ...
        Console.WriteLine(ConvertToFarengheit(Convert.ToDouble(Console.ReadLine())));
